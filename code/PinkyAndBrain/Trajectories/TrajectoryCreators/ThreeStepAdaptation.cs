...
namespace Trajectories
{
    ...
    public class ThreeStepAdaptation:ITrajectoryCreator
    {
        ...
        public ThreeStepAdaptation(Variables variablesList , List<Dictionary<string , double>> crossVaryingVals , Dictionary<string , double> staticVals , int trajectorySampleNumber)
        {
