...
namespace Trajectories
{
    ...
    /// </summary>
    public class Azimuth3D : ITrajectoryCreator
    {
        #region ATTRIBUTES
        /// <summary>
        ...
        public Azimuth3D(MLApp.MLApp matlabApp, Variables variablesList, List<Dictionary<string, List<double>>> crossVaryingVals, Dictionary<string, List<List<double>>> staticVals, int trajectorySampleNumber)
        {
