...
namespace MotocomdotNetWrapper
{
           ...
           public void WriteFile(string Filename)
           {
            ...
            public short BscLinearMove(TrajectoryPoint trajPoint)
            {
                lock (m_YasnacAccessLock)
                {
                    ...
                    return CMotocom.BscMovl(m_Handle, new StringBuilder("V"), 1.0, new StringBuilder("ROBOT"), 0x00000000, 0, ref trajPoint._pointValues[0]);
                }
            }
    ...
    {
        public double[] _pointValues;

        public TrajectoryPoint()
        {
            _pointValues = new double[6];
        }

        public double X
        {
            get { return _pointValues[0]; }
            set { _pointValues[0] = value; }
        }

        public double Y
        {
            get { return _pointValues[1]; }
            set { _pointValues[1] = value; }
        }

        public double Z
        {
            get { return _pointValues[2]; }
            set { _pointValues[2] = value; }
        }

        public double Rx
        {
            get { return _pointValues[3]; }
            set { _pointValues[3] = value; }
        }

        public double Ry
        {
            get { return _pointValues[4]; }
            set { _pointValues[4] = value; }
        }

        public double Rz
        {
            get { return _pointValues[5]; }
            set { _pointValues[5] = value; }
        }
    }
}
